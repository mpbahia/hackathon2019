...
namespace HACKA.MEIADOIS.UI.Controllers
{
    public class FornecedoresController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,NomeFantasia,Municipio,Bairro")] Fornecedor fornecedor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,NomeFantasia,Municipio,Bairro")] Fornecedor fornecedor)
        {
            if (ModelState.IsValid)
            {
